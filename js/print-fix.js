/* Final quotation print fixes: logo, combined contact, Supabase TTD */
(function () {
  ...
  async function getLatestTemplate() {
    try {
      if (typeof db !== 'undefined' && db) {
        ...
        if (!result.error && result.data && result.data[0]) return result.data[0];
        console.warn('Template print refresh:', result.error || 'template kosong');
      }
    } catch (error) {
  ...
  async function applyFixes() {
    ...
    style.textContent = `
      ...
      #pmPrintPreview .pm-letterhead .logo { width:100px !important; height:100px !important; max-width:100px !important; max-height:100px !important; object-fit:contain !important; }
      ...
      @media print {
        ...
        #pmPrintPreview .pm-letterhead .logo { width:100px !important; height:100px !important; }
      }
    `;
