...
(function(){
  ...
  function readHeader(){const q=s=>document.querySelector(s)?.value||'';return{nama_client:S(q('#qc')),perusahaan:S(q('#qp')),telepon_wa:S(q('#qw')),telepon:S(q('#qw')),whatsapp:S(q('#qw')),email:S(q('#qe')),nama_event:S(q('#qeve')),event_name:S(q('#qeve')),event:S(q('#qeve')),tanggal_mulai:q('#qs')||'',tanggal_selesai:q('#qe2')||'',status:'DRAFT',nomor_penawaran:'',diskon:I(window.__pmDiscountValue),diskon_persen:Math.max(0,Math.min(100,N(window.__pmDiscountPct))),diskon_nominal:I(window.__pmDiscountValue)};}
